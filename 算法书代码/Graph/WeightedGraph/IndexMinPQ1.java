...
import java.util.*;
public class IndexMinPQ1<Key extends Comparable<Key>> implements Iterable<Integer> {
    ...
    ***************************************************************************/
    ...
    private class HeapIterator implements Iterator<Integer> {
        // create a new pq
        private IndexMinPQ1<Key> copy;

        // add all elements to copy of heap
        // takes linear time since already in heap order so no keys move
        public HeapIterator() {
            copy = new  IndexMinPQ1<Key>(pq.length - 1);
            for (int i = 1; i <= N; i++)
     ...
     */
    private static Random rrr;
    public static void main(String[] args) {
        // insert a bunch of strings
        String[] strings = { "it", "was", "the", "best", "of", "times", "it", "was", "the", "worst" };

        IndexMinPQ1<String> pq = new IndexMinPQ1<String>(strings.length);
